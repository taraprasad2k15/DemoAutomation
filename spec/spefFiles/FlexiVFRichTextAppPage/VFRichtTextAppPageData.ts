...
export const VFRichtTextAppPageData = {
    VFPSI: {
		new: {
			"itemDefinition": {
				"itemClass": "Page",
	...
	accountName: {
		Xpath: "//th[contains(normalize-space(.),'Account Name')]/following-sibling::td/div/input",
		fieldDetails: {
                                                            ...
                                                            "value": [
                                                                {
                                                                    ...
                                                                    "uri": [
                                                                        "ui:locator?name=accountName&binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DAccount%26field%3DName"
                                                                    ]
                                                                }
                                                            ]
                                                        },
    ...
    type:{
		Xpath: "//th[contains(normalize-space(.),'Type')]/following-sibling::td/select",
		fieldDetails: {
			"platformElementLocators": [
				{
					"elementLocator": {
    ...
    phone:{
		Xpath: "//th[contains(normalize-space(.),'Phone')]/following-sibling::td/input",
		fieldDetails: {
			"platformElementLocators": [
				{
					"elementLocator": {
    ...
    richtextfield: {
        ...
        xpath: "//div[contains(@class,'active')]//div[contains(text(),'Some custom text')]",
        xpathUB: "//div[contains(@class,' slds-is-open')]//p[normalize-space(.)='Testing Rich Text Utility Bar']",
        fieldDetails:{

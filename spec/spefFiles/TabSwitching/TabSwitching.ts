...
export const SfNewCase = {
	caseType: {
		...
		withPrimaryandSecondaryTabName: {
			pageStructureParameters: [{
				level: 1,
				type: 'Scaffold',
				pageLayout: 'SfConsoleLightningPageScaffoldExtension',
				tabName: 'ExistingTab',
				primary: 'New Case',
				secondary: 'Details',
			}],
							...
							"steps": [
								{
									"apiCall": [
										{
											"title": [
												"Set the Type picklist to Feature Request"
											],
											"arguments": [
												{
													"argument": [
            ...
            "children": [
                {
                    "name": "UiDoAction",
                    "type": "Icon-Successful",
                    "text": "Set the Case Origin picklist to Phone",
                    "executionStatus": "Executed",
                }
            ]
        },
							...
							"steps": [
								{
									"apiCall": [
										{
											"title": [
												"Set the Case Origin picklist to Phone"
											],
											"arguments": [
												{
													"argument": [

...
export const SfAccountLogACall = {
    logACallPSI:{
        itemDefinition: {
			itemClass: 'Page',
            ...
            "children": [
                {
                    "name": "UiWithRow",
                    "type": "Icon-ExecutingPaused",
                    "text": "With Past Activity Timeline {subject = \"Send Letter\"}",
                    "executionStatus": "Executing",
                    "successfulCount": 0,
                    "children": [
                        {
							...
							"steps": [
								{
									"apiCall": [
										{
											"title": [
												"With Past Activity Timeline {subject = \"Send Letter\"}"
											],
											"arguments": [
												{
													"argument": [
																									...
																									"uiFieldAssertion": [
																										{
																											...
																											"fieldLocator": [
																												{
																													"uri": [
																														/ui:locator\?name=subject&binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DTask%26field%3Dsubject|ui:locator\?binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DTask%26field%3Dsubject&name=subject/
																													]
																												}
																											],
																											"attributeAssertions": [
	...
	activityTabSummary:{
		Xpath: "//div[contains(@class,'summary')]/div[contains((.),'You logged a call with')]",
		fieldDetails:{
			disposition: "Existing",
									...
									"uiFieldAssertion": [
										{
											...
											"fieldLocator": [
												{
													"uri": [
														/ui:locator\?name=summary&binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DTask%26field%3Dsummary|ui:locator\?binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DTask%26field%3Dsummary&name=summary/
													]
												}
											],
											"attributeAssertions": [
													...
													"uiAttributeAssertion": [
														{
															...
															"value": [
																{
																	"text": /You logged a call with AutomationContact.*/,
																	"class": [
																		"value"
																	],
																	"valueClass": [
	...
	activityTabSDueDate:{
		Xpath: "//div[contains(@class,'time')]/div[(.)='Today']",
		fieldDetails:{
			disposition: "Existing",
									...
									"uiFieldAssertion": [
										{
											...
											"fieldLocator": [
												{
													"uri": [
														/ui:locator\?name=activityDate&binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DTask%26field%3DactivityDate|ui:locator\?binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DTask%26field%3DactivityDate&name=activityDate/
													]
												}
											],
											"attributeAssertions": [
	...
	activityTabTask:{
		Xpath: "//div[(.)='Name']/following-sibling::div/div/a[contains(@class,'outputLookupLink') and contains((.),'AutomationContact')]",
		fieldDetails:{
			disposition: "Existing",
			text: "Task : Name (Task_WhoId)",
		},
		interactionParameters:{
			readAssert:{
				interactionParameters:{
									...
									"uiFieldAssertion": [
										{
											...
											"fieldLocator": [
												{
													"uri": [
														/ui:locator\?name=Task_WhoId&binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DTask%26field%3DWhoId|ui:locator\?binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DTask%26field%3DWhoId&name=Task_WhoId/
													]
												}
											],
											"attributeAssertions": [
	...
	activityTabDescription:{
		Xpath: "//div[(.)='Description']/following-sibling::div[(.)='Comments for the QA via Automation Script']",
		fieldDetails:{
			disposition: "Existing",
									...
									"uiFieldAssertion": [
										{
											...
											"fieldLocator": [
												{
													"uri": [
														/ui:locator\?name=comments&binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DTask%26field%3Dcomments|ui:locator\?binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DTask%26field%3Dcomments&name=comments/
													]
												}
											],
											"attributeAssertions": [
													...
													"uiAttributeAssertion": [
														{
															...
															"value": [
																{
																	"text": "Comments for the QA via Automation Script",
																	"class": [
																		"value"
																	],
																	"valueClass": [

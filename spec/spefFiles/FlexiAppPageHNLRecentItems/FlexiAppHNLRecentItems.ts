...
export const FlexiAppHNLRecentItems = {


    PSI: {
        itemDefinition: {
            itemClass: 'Page',
            //uiTargetUri: 'sf:ui:target?flexiPath=region1::1&flexiPage=Regression_App_Page_Header_and_Left&lightningComponent=flexipage:recentItems',
            itemTypeId: 'SfFlexiUiTargetExtension',
        },
        pageDetails: {
            title: 'Recent Items component in Regression App Page Header and Left',
        },
    },
    accountName: {
        ...
        testCaseXMLClick:
        {
            ...
            "title": [
                "On SF Recent Items 1 component in Regression App Page Header and Left"
            ],
            "arguments": [
                {
                    "argument": comparisonUtils.addCompareOptions([
                            ...
                            "value": [
                                {
                                    ...
                                    "uri": [
                                        "sf:ui:target?lightningComponent=flexipage%3ArecentItems&flexiPath=region1%3A%3A1&flexiPage=Regression_App_Page_Header_and_Left"
                                    ]
                                }
                            ]
                        },
                        ...
                        },
                        {
                            ...
                            "value": [
                                {
                                    "text": "On SF Recent Items 1 component in Regression App Page Header and Left",
                                    "class": [
                                        "value"
                                    ],
                                    "valueClass": [
    ...
    type: {
        xpath: "(//div[@class='recentItemsContainer flexipageRecentItems']//div[normalize-space(.)='Type']//following-sibling::div/span)[1]",
        fieldDetails: {
            disposition: 'Existing',
    ...
    billingAddress: {
        xpath: "(//div[@class='recentItemsContainer flexipageRecentItems']//div[normalize-space(.)='Billing Address']//following-sibling::div)[1]",
        fieldDetails: {
            disposition: 'Existing',

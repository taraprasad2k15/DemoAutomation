...
export const CaseRL = {
	newButton: {
		Xpath: "(//span[@title='Cases'])[2]/../../../../..//a[.='New']",
		executionStatus: {
			"name": "UiWithScreen",
	...
	caseNumber: {
		//Xpath: "(//a[starts-with(text(),'000')])[2]",
		Xpath: "//div[contains(@class,'forceRelatedListSingleContainer')]//a[starts-with(text(),'000')]",
		executionStatus: [
			{
				"name": "UiWithRow",
				"type": "Icon-ExecutingPaused",
	...
	subject: {
		Xpath: "(//a[contains((.),'Testing Case RL on PCO')])[2]",
		testCaseXML: [{
			"name": [
				"UiAssert"
			],
	...
	viewAllButton: {
		Xpath: "(//div[contains(@class,'force')]//span[@class='view-all-label'])[2]",
		executionStatus: [{
			"name": "UiDoAction",
			"type": "Icon-Successful",

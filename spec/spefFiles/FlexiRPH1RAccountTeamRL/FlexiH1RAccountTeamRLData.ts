...
export const FlexiH1RAccountTeamRLData = {
    accountViewPsi: {
        itemDefinition: {
            itemClass: 'Page',
            uiTargetUri: /sf:ui:target\?flexiPath=main:\'relatedListsTab\':0&flexiPage=Regression_Account_Record_Header_and_1_Col&.*relatedListContainer.*/,
            itemTypeId: 'SfFlexiUiTargetExtension',
        },
        pageDetails: {
            title: 'Related Lists  component in Account  (Header and 1 Column)  view',
        },
    },
    ...
    addDefaultTeam: {
        ...
        testCaseXML: {
            ...
            "title": [
                "On SF Related Lists component in Account (Header and 1 Column) view"
            ],
            "arguments": [
                {
                    argument: comparisonUtils.addCompareOptions([
                            ...
                            "value": [
                                {
                                    ...
                                    "uri": [
                                        "sf:ui:target?lightningComponent=force%3ArelatedListContainer&flexiPath=main%3Afacet-b2231774-7d02-490e-af87-6eced52413ce%3A0&flexiPage=Regression_Account_Record_Header_and_1_Col&recordType=Header+and+1+Column"
                                    ]
                                }
                            ]
                        },
                        ...
                        },
                        {
                            ...
                            "value": [
                                {
                                    "text": "On SF Related Lists component in Account (Header and 1 Column) view",
                                    "class": [
                                        "value"
                                    ],
                                    "valueClass": [
                                            ...
                                            "uiColumnAssertion": [
                                                {
                                                    ...
                                                    "fieldLocator": [
                                                        {
                                                            "uri": [
                                                                "ui:locator?name=accountAccess&path=teams"
                                                            ]
                                                        }
                                                    ],
                                                    "attributeAssertions": [
                                            ...
                                            "uiColumnAssertion": [
                                                {
                                                    ...
                                                    "fieldLocator": [
                                                        {
                                                            "uri": [
                                                                "ui:locator?name=user&path=teams"
                                                            ]
                                                        }
                                                    ],
                                                    "attributeAssertions": [
                            ...
                            "value": [
                                {
                                    ...
                                    "uri": [
                                        /sf:ui:target\?((&*lightningComponent=force%3ArelatedListContainer.*|&*flexiPath=main.*|&*flexiPage=Regression_Account_Record_Header_and_1_Col|&*recordType=Header\+and\+1\+Column|recordType=Header\+and\+1\+Column){4})/
                                    ]
                                }
                            ]
                        },
                            ...
                            "steps": [
                                {
                                    "apiCall": [
                                        {
                                            "title": [
                                                "With AccountTeamMembers rows {1}"
                                            ],
                                            "arguments": [
                                                {
                                                    "argument": [
                                                            ...
                                                            "value": [
                                                                {
                                                                    ...
                                                                    "uri": [
                                                                        "sf:ui:locator:row?table=AccountTeamMembers%2FAccountTeamMembersTable"
                                                                    ]
                                                                }
                                                            ]
                                                        },
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            "value": [
                                                                {
                                                                    "text": "With AccountTeamMembers rows {1}",
                                                                    "class": [
                                                                        "value"
                                                                    ],
                                                                    "valueClass": [
    ...
    teamMemberOnView: {
        xpath: "//th[@title='Team Member']/ancestor::table//th//a",
        fieldDetails: {
            disposition: 'Existing',
                                ...
                                "value": [
                                    {
                                        ...
                                        "uri": [
                                            /sf:ui:target\?((&*lightningComponent=force%3ArelatedListContainer|&*flexiPath=main.*|&*flexiPage=Regression_Account_Record_Header_and_1_Col|&*recordType=Header\+and\+1\+Column){4})/
                                        ]
                                    }
                                ]
                            },
                            ...
                            "steps": [
                                {
                                    "apiCall": [
                                        {
                                            "title": [
                                                "With AccountTeamMembers rows {MEMBER_NAME = \"Provar Admin\"}"
                                            ],
                                            "arguments": [{
                                                argument: comparisonUtils.addCompareOptions([
                                                    {
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        "value": [
                                                            {
                                                                "text": "With AccountTeamMembers rows {MEMBER_NAME = \"Provar Admin\"}",
                                                                "class": [
                                                                    "value"
                                                                ],
                                                                "valueClass": [
    ...
    teamRoleOnView: {
        xpath: "//th[@title='Team Member']/ancestor::table//td/span",
        fieldDetails: {
            disposition: 'Existing',
    ...
    heading: {
        ...
        xpath2:"(//span[contains(@title,'Account Team')])[2]",
        xpath1: "(//span[contains(@title,'Account Team')])[last()]",
        fieldDetails: {
            disposition: 'Existing',
    ...
    delete: {
        xpath: "//div[@class='modal-container slds-modal__container']//tbody/tr[2]//button/lightning-primitive-icon",
        fieldDetails: {
            disposition: 'Existing',
            text: 'Delete (delete)',
        },

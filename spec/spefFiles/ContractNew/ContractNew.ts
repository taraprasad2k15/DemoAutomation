...
export const NewContract = {
	...
	contractTerm: {
		xpath: miscUtilsObj.getFieldXpathLightning(ScreenType.New, 'Contract Term (months)', FieldType.Text),
		fieldDetails: {
			disposition: 'Existing',
		...
		testCaseXML: [{
			...
			"title": [
				"Set the Contract Term (months) field to 1"
			],
			"arguments": [
				{
					argument: comparisonUtils.addCompareOptions([
						...
						},
						{
							...
							"value": [
								{
									"text": "Set the Contract Term (months) field to 1",
									"class": [
										"value"
									],
									"valueClass": [
	...
	contractStartDate: {
		xpath: "//div[contains(@class,'forceRecordLayout')]//span[normalize-space()='Contract Start Date']/../following-sibling::div/input",
		fieldDetails: {
			disposition: 'Existing',
		...
		testCaseXML: [{
			...
			"title": [
				/Set the Contract Start Date field to.*/
			],
			"arguments": [
				{
					argument: comparisonUtils.addCompareOptions([
	...
	ownerExpirationNotice: {
		xpath: miscUtilsObj.getFieldXpathLightning(ScreenType.New, 'Owner Expiration Notice', FieldType.Picklist),
		fieldDetails: {
			disposition: 'Existing',
		...
		testCaseXML: [{
			...
			"title": [
				"Set By Index the Owner Expiration Notice picklist to 2"
			],
			"arguments": [
				{
					argument: comparisonUtils.addCompareOptions([
						...
						},
						{
							...
							"value": [
								{
									"text": "Set By Index the Owner Expiration Notice picklist to 2",
									"class": [
										"value"
									],
									"valueClass": [
	...
	specialTerms: {
		xpath: miscUtilsObj.getFieldXpathLightning(ScreenType.New, 'Special Terms', FieldType.Textarea),
		fieldDetails: {
			disposition: 'Existing',
		...
		testCaseXML: [{
			...
			"title": [
				"Set the Special Terms field to Terms"
			],
			"arguments": [
				{
					argument: comparisonUtils.addCompareOptions([
						...
						},
						{
							...
							"value": [
								{
									"text": "Set the Special Terms field to Terms",
									"class": [
										"value"
									],
									"valueClass": [
	...
	companySignedDate: {
		xpath: "//span[normalize-space()='Company Signed Date']/../following-sibling::div/input",
		fieldDetails: {
			disposition: 'Existing',
		...
		testCaseXML: [{
			...
			"title": [
				"Set the Company Signed Date field to {DateAdd(TODAY)}"
			],
			"arguments": [
				{
					argument: comparisonUtils.addCompareOptions([
						...
						},
						{
							...
							"value": [
								{
									"text": 'Set the Company Signed Date field to {DateAdd(TODAY)}',
									"class": [
										"value"
									],
									"valueClass": [
		...
		executionStatus: [{
			name: "UiDoAction",
			type: "Icon-Successful",
			text: /Set the Company Signed Date field to.*/,
			executionStatus: "Executed",
			successfulCount: 1,
		}],
	},
	customerSignedBy: {
		xpath: "//span[normalize-space()='Customer Signed By']/../following-sibling::div//input",
		xpath1: "//span[normalize-space()='Customer Signed By']/../following-sibling::div//div//span[@class='pillText']",
		fieldDetails: {
			disposition: 'Existing',
		...
		testCaseXML: [
			{
				name: ['UiDoAction'],
			title: [/Lookup the Customer Signed By reference to.*/],
				arguments: [{
					argument: comparisonUtils.addCompareOptions([{
						id: ['interaction'],
						value: [{
		...
		executionStatus: [{
			name: 'UiDoAction',
			type: 'Icon-Successful',
			text: /Lookup the Customer Signed By reference to .*/,
			executionStatus: 'Executed',
			successfulCount: 1,
		},
		{
	...
	customerSignedDate: {
		xpath: "//span[normalize-space()='Customer Signed Date']/../following-sibling::div//input",
		fieldDetails: {
			disposition: 'Existing',
			text: 'Customer Signed Date (CustomerSignedDate)',
		},
		testCaseXML:
		[{
			"apiId": [
									...
									"uiFieldAssertion": [
										{
											...
											"fieldLocator": [
												{
													"uri": [
														"ui:locator?name=CustomerSignedDate&binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DContract%26field%3DCustomerSignedDate"
													]
												}
											],
											"attributeAssertions": [
									...
									"uiFieldAssertion": [
										{
											...
											"fieldLocator": [
												{
													"uri": [
														"ui:locator?name=BillingStreet&binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DContract%26field%3DBillingStreet"
													]
												}
											],
											"attributeAssertions": [

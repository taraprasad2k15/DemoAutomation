...
export const SfVfInsideIframeTables = {
    masterPagePSI: {
        pageBlockTable: {
            new: [
                {
            ...
            existing: [
                ...
                },
                {
                    "itemDefinition": {
                        ...
                        "embedded": true,
                        "itemName": "VIsualforceForiframe",
                        "itemLabel": "V Isualforce Foriframe",
                    },
                    "pageDetails": {
                        "title": "V Isualforce Foriframe",
                    }
            ...
            newOuter: [
                {
                    "itemDefinition": {
                        ...
                        "embedded": false,
                        "itemName": "VisualForceInsideIframe",
                        "itemLabel": "Visual Force Inside Iframe",
                    },
                    "pageDetails": {
                        "title": "Visual Force Inside Iframe",
                    }
    ...
    dataTable: {
        accountName: {
            ...
            Xpath1:"//h2[(.) = 'Accounts Data Table']/../../../../../following-sibling::div/table/tbody/tr/td[1]/span",
            fieldDetails: {
                "platformElementLocators": [
                    {
                        "elementLocator": {
            ...
            testCaseXML: {
                name: ['UiWithScreen'],
                title: ['On SF VisualForceInsideIframe page with pageobject Visual Force Inside Iframe'],
                arguments: [{
                    argument: comparisonUtils.addCompareOptions([{
                        id: ['target'],
                        value: [{}],
                ...
                clauses: [{
                    clause: [{
                        steps: [{
                            apiCall: [{
                                name: ['UiWithScreen'],
                                title: ['On SF VIsualforceForiframe page with pageobject V Isualforce Foriframe'],
                                arguments: [{
                                    argument: comparisonUtils.addCompareOptions([{
                                        id: ['target'],
                                        value: [{}],
        ...
        owner: {
            ...
            Xpath1: "//div[(.)='Account Name']/../../../following-sibling::tbody/tr/td/span/a[(.)='Richard Clark']",
            Xpath2:"//h2[(.) = 'Accounts Data Table']/../../../../../following-sibling::div/table/tbody/tr/td[2]/span/a",
            fieldDetails: {
                "platformElementLocators": [
                    {
                        "elementLocator": {
        ...
        actions: {
            Xpath: "//span[(.)='Richard Clark']/../following-sibling::td/input",
            Xpath1:"//h2[(.) = 'Accounts Data Table']/../../../../../following-sibling::div/table/tbody/tr/td[3]/input",
            fieldDetails: {
                "platformElementLocators": [
                    {
                        "elementLocator": {

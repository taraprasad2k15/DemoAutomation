...
import { QuickLinkData,CaseRL } from './QuickLinkH1C.data';
import { join } from 'path';

export class QuickLinkH1CSpec extends BaseSpec {
    public runTest() {
		...
		this.zephyrTest('AutomationAPI', 'PROT-1758', 'FS_MAP_SF_STD_RL_QuickLinks.RP.H1Col', () => {
            beforeAll(async done => {
                const debug: boolean = false;
                const tcName = 'QuickLinkH1C.testcase';

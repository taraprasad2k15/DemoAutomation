...
export const CaseRL = {
	newButton: {
		...
		executionStatus:{
            ...
            "text": "On SF Account (Header and 1 Column) Cases related list",
		...
		testCaseXML: {
			"title": [
				"On SF Account (Header and 1 Column) Cases related list"
			],
			"arguments": [
				{
					"argument": [
							...
							"value": [
								{
									...
									"uri": [
										"sf:ui:target?object=Account&relatedList=Cases&recordType=Header+and+1+Column"
									]
								}
							]
						},
															...
															"value": [
																{
																	...
																	"uri": [
																		"ui:locator?name=NewCase&binding=sf%3Aui%3Abinding%3Aobject%3Fobject%3DAccount%26action%3DNewCase%26relationship%3DCases"
																	]
																}
															]
														},
	...
	contactName: {
		Xpath: "//div[contains(@class,'previewContainer')]//tbody//th/following-sibling::td[1]/span",
		testCaseXML: [{
			"name": [
				"UiAssert"
			],

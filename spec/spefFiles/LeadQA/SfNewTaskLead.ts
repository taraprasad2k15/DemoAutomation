...
export const SfNewTaskLead = {
    ...
    NewTaskViewPSI: {
        itemDefinition: {
			itemClass: 'Page',
			uiTargetUri: 'sf:ui:target?action=QuickAction&object=Lead&quickAction=NewTask',
    ...
    save: {
        Xpath: "//div[contains(@class,'active')]//div[contains(@class,'modal-footer')]//span[normalize-space(.)='Save']",
		XpathU: "//button[contains(@class,'publisherShareButton')]/span[normalize-space(.)='Save']",
    ...
    activityTab:{
        Xpath: "//span[normalize-space(.)='Activity'] | //a[(.)='Activity']",
    },
    newTaskTab:{
        Xpath: "//a[(.)='New Task']",
	},
	activityTabSubject:{
		Xpath: "//a[contains(@class,'subjectLink') and (.)='Send Quote']",
		fieldDetails:{
			disposition: "Existing",
			text: "Subject (subject)",
		},
		...
		executionStatus: {
            ...
            "text": "On SF Lead Activity Timeline screen",
            "executionStatus": "Executing",
            "successfulCount": 0,
            "children": [
                {
		...
		testCaseXML:{
			"title": [
				"On SF Lead Activity Timeline screen"
			],
			"arguments": [
				{
					"argument": [
							...
							"value": [
								{
									...
									"uri": [
                                        "sf:ui:target?object=Lead&action=ActivityTimeline"
									]
								}
							]
						},
															...
															"value": [
																{
																	...
																	"uri": [
																		"sf:ui:locator:row?table=nextSteps%2FnextStepsTimeline"
																	]
																}
															]
														},
	...
	activityTimelinePSI:{
		itemDefinition: {
			itemClass: 'Page',
			uiTargetUri: 'sf:ui:target?action=ActivityTimeline&object=Lead',
			itemTypeId: 'SfLayoutUiTargetExtension', 
		},
		pageDetails: {
			title: 'Lead Activity timeline screen',
		},
	},
}
...
export const QuoteAddProductSectionsLayoutData = {
    newPagePSI: {
        "itemDefinition": {
            "itemClass": "Page",
    ...
    searchProducts: {
        ...
        testCaseXML:
            [{
                ...
                "title": [
                    "Set the Search Products field to iPhoneXPack"
                ],
                "arguments": [
                    {
                        argument: comparisonUtils.addCompareOptions(
                            [
                                ...
                                },
                                {
                                    ...
                                    "value": [
                                        {
                                            "text": "Set the Search Products field to iPhoneXPack",
                                            "class": [
                                                "value"
                                            ],
                                            "valueClass": [
    ...
    memoryCardsCheckbox: {
        xpath: "//h2[text()='Memory Cards']/../following-sibling::div//sb-table-row[1]//div[@id='checkboxContainer']",
        fieldDetails: {
            "platformElementLocators": [
                {
                    "elementLocator": {
        ...
        testCaseXML: {
            ...
            "title": [
                "On SF SBQQ__sb page with pageobject Sbqq__ Applei Phone X Package__ CPQ Product"
            ],
            "arguments": [
                {
                    argument: comparisonUtils.addCompareOptions(
                        [
                            ...
                            },
                            {
                                ...
                                "value": [
                                    {
                                        "text": "On SF SBQQ__sb page with pageobject Sbqq__ Applei Phone X Package__ CPQ Product",
                                        "class": [
                                            "value"
                                        ],
                                        "valueClass": [
                                    ...
                                    "apiCall": [
                                        {
                                            ...
                                            "title": [
                                                "With Memory Cards Lines rows {1}"
                                            ],
                                            "arguments": [{
                                                argument: comparisonUtils.addCompareOptions(
                                                    [
                                                            ...
                                                            "value": [
                                                                {
                                                                    ...
                                                                    "uri": [
                                                                        "sf:ui:locator:row?table=memoryCardsLines"
                                                                    ]
                                                                }
                                                            ]
                                                        },
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            "value": [
                                                                {
                                                                    "text": "With Memory Cards Lines rows {1}",
                                                                    "class": [
                                                                        "value"
                                                                    ],
                                                                    "valueClass": [
    ...
    memoryCardsQuantity: {
        xpath: "//h2[text()='Memory Cards']/../following-sibling::div//sb-table-row[1]//sb-option-cell[contains(@item,'SBQQ__Quantity__c')]",
        modificationParameters: {
            interactionParameters: {
                id: 'Set',
                settings: {
    ...
    headphonesCheckbox: {
        xpath: "//h2[text()='HeadPhones']/../following-sibling::div//sb-table-row[1]//div[@id='checkboxContainer']",
        fieldDetails: {
            "platformElementLocators": [
                {
                    "elementLocator": {
                ...
                argument: comparisonUtils.addCompareOptions(
                    [
                            ...
                            "value": [
                                {
                                    ...
                                    "uri": [
                                        "sf:ui:locator:row?table=headPhonesLines"
                                    ]
                                }
                            ]
                        },
                        ...
                        },
                        {
                            ...
                            "value": [
                                {
                                    "text": "With Head Phones Lines rows {1}",
                                    "class": [
                                        "value"
                                    ],
                                    "valueClass": [
    ...
    headphonesQuantity: {
        xpath: "//h2[text()='HeadPhones']/../following-sibling::div//sb-table-row[1]//sb-option-cell[contains(@item,'SBQQ__Quantity__c')]",
        fieldDetails: {
            "platformElementLocators": [
                {
                    "elementLocator": {
    ...
    addOptions: {
        xpath: "//h2[text()='Mobile Cases']/../following-sibling::div//a/*[text()='Add Options']",
        fieldDetails: {
            "platformElementLocators": [
                {
                    "elementLocator": {
                        ...
                        argument: comparisonUtils.addCompareOptions(
                            [
                                ...
                                },
                                {
                                    ...
                                    "value": [
                                        {
                                            "text": "Click the Add Options button",
                                            "class": [
                                                "value"
                                            ],
                                            "valueClass": [
    ...
    mobileCasesCheckbox: {
        xpath: "//sb-table-row[@id='row'][1]//div[@id='selectionContainer']//div[@id='checkbox']",
        fieldDetails: {
            "platformElementLocators": [
                {
                    "elementLocator": {
                                    ...
                                    "apiCall": [
                                        {
                                            ...
                                            "title": [
                                                "With Configure Products Lines rows {1}"
                                            ],
                                            "arguments": [{
                                                argument: comparisonUtils.addCompareOptions(
                                                    [
                                                            ...
                                                            "value": [
                                                                {
                                                                    ...
                                                                    "uri": [
                                                                        "sf:ui:locator:row?table=configureProductsLines"
                                                                    ]
                                                                }
                                                            ]
                                                        },
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            "value": [
                                                                {
                                                                    "text": "With Configure Products Lines rows {1}",
                                                                    "class": [
                                                                        "value"
                                                                    ],
                                                                    "valueClass": [
    ...
    mobileCasesQuantity: {
        xpath: "//h2[text()='Mobile Cases']/../following-sibling::div//sb-table-row[1]//sb-option-cell[contains(@item,'SBQQ__Quantity__c')]",
        modificationParameters: {
            interactionParameters: {
                id: 'Set',
                settings: {
                                    ...
                                    "apiCall": [
                                        {
                                            ...
                                            "title": [
                                                "With Mobile Cases Lines rows {1}"
                                            ],
                                            "arguments": [{
                                                argument: comparisonUtils.addCompareOptions([
                                                    {
                                                        ...
                                                        "value": [
                                                            {
                                                                ...
                                                                "uri": [
                                                                    "sf:ui:locator:row?table=mobileCasesLines"
                                                                ]
                                                            }
                                                        ]
                                                    },
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        "value": [
                                                            {
                                                                "text": "With Mobile Cases Lines rows {1}",
                                                                "class": [
                                                                    "value"
                                                                ],
                                                                "valueClass": [

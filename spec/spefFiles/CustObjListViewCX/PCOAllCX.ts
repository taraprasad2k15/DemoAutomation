...
export const SfPCOAllCX = {
	selectRow:{
		Xpath: "(//tr/td//input[@type='checkbox'])[2]",
	...
	name: {
		Xpath: "//table/tbody/tr//td/div[contains(@class,'NAME')]/a/span",
		interactionParameters: {
			interactionParameters: {
			id: 'Read/Assert',
			settings: {
	...
	deleteActionButton:{
		...
		testCaseXML: [{
			name: ['UiDoAction'],
			title: ['Click and Cancel the Delete button'],
			arguments: [{
				argument: comparisonUtils.addCompareOptions([{
					id: ['interaction'],
					value: [{

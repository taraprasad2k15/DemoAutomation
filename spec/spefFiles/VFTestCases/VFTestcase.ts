...
export const VFTestcase = {
	...
	caseOriginSet: {
		...
		executionStatus: {
			...
			"text": "On SF TestMasterDetail page with pageobject Test Master Detail",
		...
		testCaseXML: {
			"title": [
				"On SF TestMasterDetail page with pageobject Test Master Detail"
			],
			"arguments": [
				{
					"argument": [
	...
	customDate: {
		...
		XpathLink: "//th[normalize-space(.)='Custom Date Field']/following-sibling::td/span[contains(@class,'dateOnlyInput')]/input/following-sibling::span/a",
		fieldDetails: {
			"platformElementLocators": [
				{
					"elementLocator": {
		...
		executionStatus: [{
			"name": "UiDoAction",
			"type": "Icon-Successful",
			"text": "Set the Custom Date Field 1 field to 01-01-2019",
			"executionStatus": "Executed",
			"successfulCount": 1,
		}],
		testCaseXML: [{
			"title": [
				"Set the Custom Date Field 1 field to 01-01-2019"
			],
			"arguments": [
				{
					"argument": [
							...
							"value": [
								{
									...
									"uri": [
										"ui:locator?name=customDateField1"
									]
								}
							]
						},
		...
		executionStatusToday: [{
			"name": "UiDoAction",
			"type": "Icon-Successful",
			"text": "Today link the Custom Date Field button",
			"executionStatus": "Executed",
			"successfulCount": 1,
		}],
		testCaseXMLToday: [{
			name: ['UiDoAction'],
			title: ['Today link the Custom Date Field button'],
			arguments: [{
				argument: comparisonUtils.addCompareOptions([{
					id: ['interaction'],
					value: [{

...
export const VFInsideIframePageSCV = {
    VFPSI: {
        new: [
            {
                "itemDefinition": {
    ...
    actions: {
        Xpath: "//span[(.)='Sample Case for Automation Testing']/../following-sibling::td/input",
        fieldDetails: {
        ...
        testCaseXML: {
            name: ['UiWithScreen'],
            title: ['On SF TestMasterDetail page with pageobject Test Master Detail'],
            arguments: [{
                argument: comparisonUtils.addCompareOptions([{
                    id: ['target'],
                    value: [{
                        uri: [/sf:ui:target.*pageObject=.*&page=TestMasterDetail/],
                    }],
                            ...
                            "value": [
                                {
                                    ...
                                    //  "uri": [
                                    //    //sf:ui:target.*pageObject=.*&page=VisualForceInsideIframe/
                                    //      /sf:ui:target?pageObject=.*&page=VisualForceInsideIfram.*/
                                    //  ],
                                }
                            ]
                        },

...
export const SfAddLeadCMRLSelect = {
    campaignViewPSI: {
        itemDefinition: {
            itemClass: 'Page',
    ...
    byKeyword: {
        ...
        executionStatus: {
            ...
            children: [{
                name: 'UiDoAction',
                type: 'Icon-Successful',
                text: /Lookup the By Keyword reference to AutomationLead[a-zA-Z]{4}/,
                executionStatus: 'Executed',
                successfulCount: 1,
            },
            {
                ...
                children: [
                    {
                        name: 'UiDoAction',
                        type: 'Icon-Successful',
                        text: /Set the Search text to AutomationLead[a-zA-Z]{4}/,
                        executionStatus: 'Executed',
                        successfulCount: 1,
                    },
                    {
            ...
            clauses: [{
                clause: [{
                    steps: [{
                        ...
                        {
                            name: ['UiWithScreen'],
                            title: ['On SF Lead Lookup screen'],
                            arguments: [{
                                argument: comparisonUtils.addCompareOptions([{
                                    id: ['target'],
                                    value: [{
                                        uri: ['sf:ui:target?lookup=Lead'],
                                    }],
                                }], { partial: true, indexKey: 'id' }),
                            }],
                            clauses: [{
    ...
    selectRow: {
        ...
        executionStatus: [{
            name: "UiWithRow",
            type: "Icon-ExecutingPaused",
            //text: /With ObjectSearchMultiAdd\/LeadBlock\/LeadTable \{Name = \"AutomationLead[a-zA-Z]{4}\"\}/,
            text: /With Lead Table \{Name = \"AutomationLead[a-zA-Z]{4}\"\}/,
            executionStatus: "Executing",
            successfulCount: 0,
            children: [{
                name: 'UiDoAction',
        ...
        testCaseXML: [{
            name: ['UiWithRow'],
            //title: [/With ObjectSearchMultiAdd\/LeadBlock\/LeadTable \{Name = \"AutomationLead[a-zA-Z]{4}\"\}/],
            title: [/With Lead Table \{Name = \"AutomationLead[a-zA-Z]{4}\"\}/],
            arguments: [{
                argument: comparisonUtils.addCompareOptions([
                    {
                        "id": [
                        ...
                        "value": [
                            {
                                ...
                                "uri": [
                                    "sf:ui:locator:row?table=ObjectSearchMultiAdd%2FLeadBlock%2FLeadTable"
                                ]
                            }
                        ]
                    },

...
export const SfVfInsideVFTables = {
    masterPagePSI: {
        pageBlockTable: {
            new: [
                {
    ...
    dataTable: {
        accountName: {
            ...
            testCaseXML: {
                name: ['UiWithScreen'],
                title: ['On SF VFInsideVF page with pageobject VF Inside VF'],
                arguments: [{
                    argument: comparisonUtils.addCompareOptions([{
                        id: ['target'],
                        value: [{}],
        ...
        owner: {
            ...
            Xpath2:"(//div[(.)='Account Name']/../../../following-sibling::tbody/tr/td/span/a[(.)])[1]",
            fieldDetails: {
                "platformElementLocators": [
                    {
                        "elementLocator": {
        ...
        actions: {
            ...
            Xpath1:"(//div[(.)='Account Name']/../../../following-sibling::tbody/tr/td/input)[1]",
            fieldDetails: {
                "platformElementLocators": [
                    {
                        "elementLocator": {

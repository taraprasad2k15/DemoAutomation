...
export const FlexiHSLAccountTeamRLData = {
    accountViewPsi: {
        itemDefinition: {
            itemClass: 'Page',
            uiTargetUri: /sf:ui:target\?flexiPath=subheader:\'relatedListsTab\':0&flexiPage=Regression_Account_Record_Header_Subheader_and_Left&.*relatedListContainer.*/,
            itemTypeId: 'SfFlexiUiTargetExtension',
        },
        pageDetails: {
            title: 'Related Lists  component in Account  (Header Subheader and Left)  view',
        },
    },
    ...
    addDefaultTeam: {
        ...
        testCaseXML: {
            ...
            "title": [
                "On SF Related Lists component in Account (Header Subheader and Left) view"
            ],
            "arguments": [
                {
                    argument: comparisonUtils.addCompareOptions([
                            ...
                            "value": [
                                {
                                    ...
                                    "uri": [
                                        "sf:ui:target?lightningComponent=force%3ArelatedListContainer&flexiPath=subheader%3Afacet-b2cf2531-69f4-471a-b51f-59919a37e082%3A0&flexiPage=Regression_Account_Record_Header_Subheader_and_Left&recordType=Header+Subheader+and+Left"
                                    ]
                                }
                            ]
                        },
                        ...
                        },
                        {
                            ...
                            "value": [
                                {
                                    "text": "On SF Related Lists component in Account (Header Subheader and Left) view",
                                    "class": [
                                        "value"
                                    ],
                                    "valueClass": [
                            ...
                            "value": [
                                {
                                    ...
                                    "uri": [
                                        /sf:ui:target.*lightningComponent=force%3ArelatedListContainer.*/
                                    ]
                                }
                            ]
                        },

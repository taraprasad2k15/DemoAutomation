...
import { VFTestcase } from './VFInsideVF';
import { join } from 'path';
import { Case } from '../../testdata/sfObjects/Case';
import { SfCommonFIeld } from '../SfCommonField'

export class VFInsideVFSpec extends BaseSpec {
	public runTest() {
		...
		this.zephyrTest('AutomationAPI', 'PROT-1345', 'FS_MAP_SF_DT_CX_PICKLIST_VF_INSIDE_VF_INPUT.SET', () => {
		...
		this.zephyrTest('AutomationAPI', 'PROT-1346', 'FS_MAP_SF_DT_CX_PICKLIST_VF_INSIDE_VF_INPUT.SETBYINDEX', () => {
			beforeEach(() => {
				this.beforeEach();
			});
			this.step('Mapping Case Origin field', async () => {
		...
		this.zephyrTest('AutomationAPI', 'PROT-1347', 'FS_MAP_SF_DT_CX_TEXT_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1348', 'FS_MAP_SF_DT_CX_TEXTAREA_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1349', 'FS_MAP_SF_DT_CX_CHECKBOX_VF_INSIDE_VF_INPUT.CHECK', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1350', 'FS_MAP_SF_DT_CX_CHECKBOX_VF_INSIDE_VF_INPUT.UNCHECK', () => {
			beforeEach(() => {
				this.beforeEach();
			});
			this.step('Mapping Checkbox field', async () => {
		...
		this.zephyrTest('AutomationAPI', 'PROT-1351', 'FS_MAP_SF_DT_CX_CHECKBOX_VF_INSIDE_VF_INPUT.TOGGLE', () => {
			beforeEach(() => {
				this.beforeEach();
			});
			this.step('Mapping Checkbox field', async () => {
		...
		this.zephyrTest('AutomationAPI', 'PROT-1352', 'FS_MAP_SF_DT_CX_TIME_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1353', 'FS_MAP_SF_DT_CX_MULTI SELECT PICKLIST_VF_INSIDE_VF_INPUT.SELECT', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1354', 'FS_MAP_SF_DT_CX_MULTI SELECT PICKLIST_VF_INSIDE_VF_INPUT.DESELECT', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1355', 'FS_MAP_SF_DT_CX_DATE_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
			this.step('Mapping Custom Date field', async () => {
				...
				this.assertTestBuilderState(pageStructureInfo, VFTestcase.customDate.fieldDetails, Standard.interaction.set, Standard.applicableInteractions.DateTime.enterableMode, response.testbuilderState);
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1356', 'FS_MAP_SF_DT_CX_DATETIME_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
			this.step('Mapping Custom Date-Time field', async () => {
				...
				this.assertTestBuilderState(pageStructureInfo, VFTestcase.customDateTime.fieldDetails, Standard.interaction.set, Standard.applicableInteractions.DateTime.enterableMode, response.testbuilderState);
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1357', 'FS_MAP_SF_DT_CX_RADIOBT_VF_INSIDE_VF_INPUT.CHECK', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1358', 'FS_MAP_SF_DT_CX_CURRENCY_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1359', 'FS_MAP_SF_DT_CX_NUMBER_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1360', 'FS_MAP_SF_DT_CX_MOBILE_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1361', 'FS_MAP_SF_DT_CX_URL_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1362', 'FS_MAP_SF_DT_CX_EMAIL_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1363', 'FS_MAP_SF_DT_CX_PERCENT_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1364', 'FS_MAP_SF_DT_CX_TEXTAREALONG_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1365', 'FS_MAP_SF_DT_CX_LOOKUP_VF_INSIDE_VF_INPUT.SET', () => {
			beforeEach(() => {
				this.beforeEach();
			});
		...
		this.zephyrTest('AutomationAPI', 'PROT-1366', 'FS_MAP_SF_DT_CX_LOOKUP_VF_INSIDE_VF_INPUT.LOOKUP', () => {
			beforeEach(() => {
				this.beforeEach();
			});
			afterAll(async done => {
		...
		// this.zephyrTest('AutomationAPI', 'PROT-1367', 'FS_MAP_SF_DT_CX_RICHTEXT_VF_INSIDE_VF_INPUT.SET', () => {
		// 	beforeEach(() => {
		// 		this.beforeEach();
		// 	});

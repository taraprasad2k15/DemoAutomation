...
export const WorkOrderNew = {
	...
	workType: {
		xpath: miscUtilsObj.getFieldXpathLightning(ScreenType.New, "Work Type", FieldType.Text),
	...
	serviceTerritory: {
		xpath: miscUtilsObj.getFieldXpathLightning(ScreenType.New, "Service Territory", FieldType.Text),
		xpath1: "//div[contains(@class,'isModal inlinePanel oneRecordActionWrapper')]//span[text()='Service Territory']/../following-sibling::div//span[@class='pillText']",
		modificationParameter: {
			interactionParameters: {
				id: 'Set',
				settings: {
	...
	address: {
		...
		executionStatus: [{
			name: "UiDoAction",
			type: "Icon-Successful",
			text: /Set the Street|Address field to CA , US/,
			executionStatus: "Executed",
			successfulCount: 1,
		}],
		testCaseXML:
			[{
				...
				"title": [
					/Set the Street|Address field to CA , US/
				],
				"arguments": [
					{
						argument: comparisonUtils.addCompareOptions(
	...
	owner: {
		...
		executionStatus:
		{
			name: 'UiWithScreen',
			type: 'Icon-ExecutingPaused',
			text: 'On SF Work Order New screen',
			executionStatus: 'Executing',
			successfulCount: 0,
			children: [
				{
							...
							"value": [
								{
									...
									"uri": [
										"sf:ui:target?object=WorkOrder&action=New&noOverride=true"
									]
								}
							]
						},

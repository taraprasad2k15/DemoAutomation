...
export class SLDSSpec extends BaseSpec {
	public runTest() {
		...
		this.zephyrTest('AutomationAPI', 'PROT-2243', 'FS_MAP_SF_LAYOUT_SLDS', () => {
			...
			this.step('Add & Do textInput field', async () => {
				await this.modifyAddToTestCase(SLDS.textInput.modificationParameters);
			...
			this.step('Add & Do textarea field', async () => {
				await this.modifyAddToTestCase(SLDS.textarea.modificationParameters);
				const response: CompleteAddToTestCaseResponse = await this.completeAddToTestCase(CompleteAction.AddAndDo);
				const testItemId: string = this.miscUtils.findTestItemIdForName(this.testCaseXMLStringTemplate, 'UiWithScreen');
			...
			this.step('Add & Do checkbox field', async () => {
				await this.modifyAddToTestCase(SLDS.checkbox.modificationParameters);
				const response: CompleteAddToTestCaseResponse = await this.completeAddToTestCase(CompleteAction.AddAndDo);
				const testItemId: string = this.miscUtils.findTestItemIdForName(this.testCaseXMLStringTemplate, 'UiWithScreen');
			...
			this.step('Add & Do monday field', async () => {
				await this.modifyAddToTestCase(SLDS.monday.modificationParameters);
				const response: CompleteAddToTestCaseResponse = await this.completeAddToTestCase(CompleteAction.AddAndDo);
				const testItemId: string = this.miscUtils.findTestItemIdForName(this.testCaseXMLStringTemplate, 'UiWithScreen');
			...
			this.step('Add & Do checkbox2 field', async () => {
				await this.modifyAddToTestCase(SLDS.checkbox2.modificationParameters);
				const response: CompleteAddToTestCaseResponse = await this.completeAddToTestCase(CompleteAction.AddAndDo);
				const testItemId: string = this.miscUtils.findTestItemIdForName(this.testCaseXMLStringTemplate, 'UiWithScreen');
			...
			this.step('Add & Do radio field', async () => {
				await this.modifyAddToTestCase(SLDS.radio.modificationParameters);
				const response: CompleteAddToTestCaseResponse = await this.completeAddToTestCase(CompleteAction.AddAndDo);
				const testItemId: string = this.miscUtils.findTestItemIdForName(this.testCaseXMLStringTemplate, 'UiWithScreen');
			...
			this.step('Add & Do wed field', async () => {
				await this.modifyAddToTestCase(SLDS.wed.modificationParameters);
				const response: CompleteAddToTestCaseResponse = await this.completeAddToTestCase(CompleteAction.AddAndDo);
				const testItemId: string = this.miscUtils.findTestItemIdForName(this.testCaseXMLStringTemplate, 'UiWithScreen');

...
export const Flexi3ColRelatedListSingle = {
    PSI: {
        itemDefinition: {
            itemClass: 'Page',
            uiTargetUri: /sf:ui:target\?flexiPath=leftsidebar::1&flexiPage=Regression_Account_Record_3_Col.*lightningComponent=force:relatedListSingleContaine.*/,
            itemTypeId: 'SfFlexiUiTargetExtension',
        },
        pageDetails: {
            title: 'Related List (Account : Contacts) 1 component in Account  (3 Col Layout)  view',
        },
    },
    PSIContactNew: {
        itemDefinition: {
    ...
    dropdownXpath:"//div[@class='previewMode SMALL forceRelatedListPreview']//span[text()='Show More' or text()='Show more actions' or text()='Show Actions']", 
    newButton: {
        xpath: "//a[@title='New' and @role='menuitem']",
        fieldDetails: {
        ...
        testCaseXML:
        {
            ...
            "title": [
                "On SF Related List (Account : Contacts) 1 component in Account (3 Col Layout) view"
            ],
            "arguments": [
                {
                    argument: comparisonUtils.addCompareOptions([
                            ...
                            "value": [
                                {
                                    ...
                                    "uri": [
                                        "sf:ui:target?lightningComponent=force%3ArelatedListSingleContainer&flexiPage=Regression_Account_Record_3_Col&flexiPath=leftsidebar%3A%3A1&recordType=3+Col+Layout"
                                    ]
                                }
                            ]
                        },
                        ...
                        },
                        {
                            ...
                            "value": [
                                {
                                    "text": "On SF Related List (Account : Contacts) 1 component in Account (3 Col Layout) view",
                                    "class": [
                                        "value"
                                    ],
                                    "valueClass": [
    ...
    email: {
        ...
        xpathViewScreen: "//div[contains(@class,'previewMode SMALL forceRelatedListPreview')]//div/div[normalize-space(.)='Email:']/following-sibling::div",
        xpathViewScreen1: "//div[contains(@class,'previewMode SMALL forceRelatedListPreview')]//div/div[normalize-space(.)='Email:']/following-sibling::div/a",
        fieldDetails: {
            disposition: 'Existing',
            text: 'Email (Email)',
        },
    ...
    title: {
        ...
        xpathViewScreen: "//div[contains(@class,'previewMode SMALL forceRelatedListPreview')]//div/div[normalize-space(.)='Title:']/following-sibling::div",
        fieldDetails: {
            disposition: 'Existing',
            text: 'Title (Title)',
        },
    ...
    phone: {
        ...
        xpathViewScreen: "//div[contains(@class,'previewMode SMALL forceRelatedListPreview')]//div/div[normalize-space(.)='Phone:']/following-sibling::div",
        fieldDetails: {
            disposition: 'Existing',
            text: 'Phone (Phone)',
        },
    ...
    contactName: {
        xpath: "//div[@class='previewMode SMALL forceRelatedListPreview']//h3//a",
        fieldDetails: {
            disposition: 'Existing',
    ...
    headerText: {
        xpath: "//slot[@slot='leftsidebar']//a/span[contains(text(),'Contacts')]/..",
        interactions: {
            interactionParameters: {
                id: 'Read/Assert',
                settings: {

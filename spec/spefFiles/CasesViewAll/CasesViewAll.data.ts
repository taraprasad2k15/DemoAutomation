...
export const CasesRLViewAllData = {
	PSI: {
		itemDefinition: {
			itemClass: 'Page',
		...
		pageDetails: {
			title: 'Cases screen for Case object',
		},
	},
	...
	caseNumber: {
		...
		testCaseXML: {
			...
			"title": [
				"On SF Case (Inquiry) Cases related list"
			],
			"clauses": [
				{
					"clause": [
		...
		executionStatus:
		{
			...
			text: 'On SF Case (Inquiry) Cases related list',
	...
	newButton: {
		...
		executionStatus: [
			{
				name: 'UiDoAction',
				type: 'Icon-Successful',
				text: 'Click the Cases New Case (Inquiry) button',
				executionStatus: 'Executed',
		...
		testCaseXML: [{
			name: ['UiDoAction'],
			title: ['Click the Cases New Case (Inquiry) button'],
			arguments: [{
				argument: comparisonUtils.addCompareOptions([{
					id: ['interaction'],
					value: [{
	...
	heading: {
		xpath: "//div[contains(@class,'active') and contains(@class,'oneContent')]//h1[normalize-space(.)='Related Cases']",
		fieldDetails: {

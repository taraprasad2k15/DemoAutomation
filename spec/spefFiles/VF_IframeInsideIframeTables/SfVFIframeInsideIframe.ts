...
export const SfIframeInsideIframeTables = {
    masterPagePSI: {
        pageBlockTable: {
            new: [
                {
    ...
    dataTable: {
        accountName: {
            ...
            testCaseXML: {
                name: ['UiWithScreen'],
                title: ['On SF IframeInsideIframe page with pageobject Iframe Inside Iframe'],
                arguments: [{
                    argument: comparisonUtils.addCompareOptions([{
                        id: ['target'],
                        value: [{}],
        ...
        owner: {
            Xpath: "//div[(.)='Account Name']/../../../following-sibling::tbody/tr/td/span",
        ...
        actions: {
            Xpath: "//span/a[(.)='Richard Clark']/../../following-sibling::td/input",

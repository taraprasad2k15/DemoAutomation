...
export const QuoteAddProductTabsLayoutData = {
    newPagePSI: {
        "itemDefinition": {
            "itemClass": "Page",
    ...
    searchProducts: {
        ...
        testCaseXML:
            [{
                ...
                "title": [
                    "Set the Search Products field to iPhoneXPackTabTesting"
                ],
                "arguments": [
                    {
                        argument: comparisonUtils.addCompareOptions(
                            [
                                ...
                                },
                                {
                                    ...
                                    "value": [
                                        {
                                            "text": "Set the Search Products field to iPhoneXPackTabTesting",
                                            "class": [
                                                "value"
                                            ],
                                            "valueClass": [
    ...
    memoryCardsCheckbox: {
        xpath: "//h2[text()='Memory Cards Tab']/../following-sibling::div//sb-table-row[1]//div[@id='checkboxContainer']",
        fieldDetails: {
            "platformElementLocators": [
                {
                    "elementLocator": {
        ...
        testCaseXML: [{
            ...
            "title": [
                "With Memory Cards Tab Lines rows {1}"
            ], 
            "clauses": [
                {
                    "clause": [
            ...
            [
                {
                    name: "UiWithRow",
                    type: "Icon-ExecutingPaused",
                    text: "With Memory Cards Tab Lines rows {1}",
                    executionStatus: "Executing",
                    successfulCount: 0,
                    children: [
                        {
    ...
    memoryCardsQuantity: {
        xpath: "//h2[text()='Memory Cards Tab']/../following-sibling::div//sb-table-row[1]//sb-option-cell[contains(@item,'SBQQ__Quantity__c')]",
        modificationParameters: {
            interactionParameters: {
                id: 'Set',
                settings: {
    ...
    headphonesCheckbox: {
        xpath: "//h2[text()='HeadPhones Tab']/../following-sibling::div//sb-table-row[1]//div[@id='checkboxContainer']",
        fieldDetails: {
            "platformElementLocators": [
                {
                    "elementLocator": {
        ...
        testCaseXML: [{
            ...
            "title": [
                "With Head Phones Tab Lines rows {1}"
            ], 
            "clauses": [
                {
                    "clause": [
        ...
        executionStatus: [{
            name: "UiWithRow",
            type: "Icon-ExecutingPaused",
            text: "With Head Phones Tab Lines rows {1}",
            executionStatus: "Executing",
            successfulCount: 0,
            children: [
                {
    ...
    headphonesQuantity: {
        xpath: "//h2[text()='HeadPhones Tab']/../following-sibling::div//sb-table-row[1]//sb-option-cell[contains(@item,'SBQQ__Quantity__c')]",
        fieldDetails: {
            "platformElementLocators": [
                {
                    "elementLocator": {
    ...
    mobileCasesCheckbox: {
        ...
        testCaseXML: {
            ...
            "title": [
                "On SF SBQQ__sb page with pageobject Sbqq__ Applei Phone X Package Tab Testing__ CPQ Product"
            ], 
            "clauses": [
                {
                    "clause": [
                            ...
                            "steps": [
                                {
                                    "apiCall": [
                                        {
                                            "title": [
                                                "With Mobile Cases Tab Lines rows {1}"
                                            ], 
                                            "clauses": [
                                                {
                                                    "clause": [
        ...
        executionStatus: {
            ...
            text: 'On SF SBQQ__sb page with pageobject Sbqq__ Applei Phone X Package Tab Testing__ CPQ Product',
            executionStatus: 'Executing',
            successfulCount: 0,
            children: [{
                name: "UiWithRow",
                type: "Icon-ExecutingPaused",
                text: "With Mobile Cases Tab Lines rows {1}",
                executionStatus: "Executing",
                successfulCount: 0,
                children: [
                    {
    ...
    mobileCasesQuantity: {
        xpath: "//h2[text()='Mobile Cases Tab']/../following-sibling::div//sb-table-row[1]//sb-option-cell[contains(@item,'SBQQ__Quantity__c')]",
        modificationParameters: {
            interactionParameters: {
                id: 'Set',
                settings: {
                                                            ...
                                                            "uiAttributeAssertion": [
                                                                {
                                                                    ...
                                                                    "value": [
                                                                        {
                                                                            "text": "Apple iPhone X Package Tab Testing",
                                                                            "class": [
                                                                                "value"
                                                                            ],
                                                                            "valueClass": [
